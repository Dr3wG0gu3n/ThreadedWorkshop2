    ...
    public static class PackageDB
    {
        ...
        public static bool UpdatePackage(Package newPackage)
        {
            ...
            string updateStatement =
                "UPDATE Packages SET PkgName = @NewName, PkgStartDate = @NewStartDate, PkgEndDate = @NewEndDate, " +
                "PkgDesc = @NewDesc, " +
        ...
        //method to delete one package record from table packages
        public static bool DeletePackageById(int packageId)
        {
            //database connection
            SqlConnection connection = TravelExpertsDB.GetConnection();
            //delete statement
        ...
        //get the latest packageId from Packages table
        public static int GetMaxPackageId()
        {
            ...
            SqlConnection connection = TravelExpertsDB.GetConnection();
            //DELETE statement
            string commandStatement = "SELECT MAX(packageId) from Packages";
